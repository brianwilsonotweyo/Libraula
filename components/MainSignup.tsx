...
interface MainSignupProps {
    handleGetStartedClick: (event: React.MouseEvent<HTMLButtonElement>) => void;
}
        ...
        <div>
            <section>
                <div className="relative w-full h-[95vh] sm:h-[80vh] md:h-[70vh] lg:h-[60vh] xl:h-[50vh] 2xl:h-[450px] lg:h-screen xl:h-screen 2xl:h-screen">
                    <div className="absolute inset-0 bg-cover bg-center brightness-50" style={{ backgroundImage: "url('https://rb.gy/dptcp5')" }}>
